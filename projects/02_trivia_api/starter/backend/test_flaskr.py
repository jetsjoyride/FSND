...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        PGHOST = 'localhost'
        PGDATABASE = 'trivia_test'
        PGUSER = 'postgres'
        PGPASSWORD = 'postgres'
        self.database_path = 'postgresql://' + PGUSER + ':' + PGPASSWORD + '@' + PGHOST + ':5432/' + PGDATABASE
    ...
    def test_get_categories_with_invalid_page(self):
    ...
    def test_get_questions_in_an_invalid_category(self):
